...
Hooks.once("ready", async function () {
  ...
  const rollTables = {
    Organizer:
      "/systems/crash-pandas/resources/roll-tables/fvtt-RollTable-Organizer.json",
    Setting:
      "/systems/crash-pandas/resources/roll-tables/fvtt-RollTable-Setting.json",
    Location:
      "/systems/crash-pandas/resources/roll-tables/fvtt-RollTable-Location.json",
    Prize:
      "/systems/crash-pandas/resources/roll-tables/fvtt-RollTable-Prize.json",
    Security:
      "/systems/crash-pandas/resources/roll-tables/fvtt-RollTable-Security.json",
    Twist:
      "/systems/crash-pandas/resources/roll-tables/fvtt-RollTable-Twist.json",
  };
